...
const workflowNodeSchema = new mongoose.Schema(
  {
    ...
    data: {
      ...
      toolConfig: {
        ...
        toolType: {
          type: String,
          enum: ["api", "database", "email", "sms", "webhook", "file", "calculation", "custom"],
        },
      ...
      conditionConfig: {
        conditionType: {
          type: String,
          enum: ["simple", "javascript", "jsonPath", "regex"],
        },
        condition: String,
        trueOutput: String,
        falseOutput: String,
      ...
      humanReviewConfig: {
        ...
        reviewPrompt: String,
        timeout: { type: Number, default: 3600000 }, // 1 hour
        escalationRules: [
          {
            condition: String,
            escalateTo: [String],
      ...
      webhookConfig: {
        ...
        authentication: {
          type: { type: String, enum: ["none", "bearer", "basic", "apiKey"] },
      ...
      triggerConfig: {
        triggerType: {
          type: String,
          enum: ["manual", "schedule", "webhook", "event", "noam"],
        },
        scheduleExpression: String, // Cron expression
        eventFilters: mongoose.Schema.Types.Mixed,
        noamEventTypes: [String],
      },
